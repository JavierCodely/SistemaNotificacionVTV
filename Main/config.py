...
# --- Archivos y Rutas ---
ARCHIVO_EXCEL = os.getenv('ARCHIVO_EXCEL', 'datos_vtv.xlsx')
...
MENSAJE_TEMPLATE = os.getenv(
    'MENSAJE_TEMPLATE',
    "Hola {nombre}! Te recordamos que la VTV de tu vehiculo patente {patente} "
...
MENSAJE_VENCIDO_TEMPLATE = os.getenv(
    ...
    "Hola {nombre}! Te informamos que la VTV de tu vehiculo patente {patente} "
    "ESTÁ VENCIDA desde el {fecha_vencimiento} (hace {dias_vencidos} días). "
    "Es urgente que la renueves para evitar multas y problemas legales. "
    "Saludos del equipo!"
)
